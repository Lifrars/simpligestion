...
if ($indicador == '7') {
    ...
    $id_user = $_SESSION['pe']['act_id'];
    $query2 = "INSERT INTO log_permisos( idpermiso, idperfil, idmodulo, idvista, elemento, permiso, tipoelemento, evento, id_user)  
		values( '$idpermiso', '$idperfil', '$idmodulo', '$idvista', '$elemento', '$permiso', '$tipoelemento', 'INSERT', '$id_user')";
...
if ($indicador == "17") {
    ...
    $qry = $datapos->prepare($query2);
    $qry-> execute();
    $rta = $qry->fetchAll(PDO::FETCH_ASSOC);
