...
function listarVotaciones(ind, inicio, nroreg) {
  ...
  fetch('backend/votacionesBackend.php', { //Pa donde vamos
    ...
    data.rta2.forEach(function (item) {
      ...
      htmlTags += '         data-tipo="TABLA_MODAL" data-apodo="Detalles Votacion" style="cursor: pointer;" title="Detalles de votación"><img src="//pos.metaversomsp.com/assets/img/icons/eye.svg" alt="img"></a>';
      htmlTags += '         <a class="me-3" id="editProducto" onclick="leerdatos(' + item.id + ');" name="editProducto"';
      htmlTags += '         data-validar="SI" data-tipo="TABLA_MODAL" data-apodo="Editar Producto" style="cursor: pointer;"title="Editar votación"><img src="//pos.metaversomsp.com/assets/img/icons/edit.svg" alt="img"></a>';
      if (item.estado === "1") {
        htmlTags += '         <a class="me-3" id="Estado1" onclick="Estado1(' + item.id + ');" name="Estado1"';
        htmlTags += '         data-validar="SI" data-tipo="TABLA_MODAL" data-apodo="Eliminar Producto" style="cursor: pointer;" title="Desactivar Votación"><img src="//pos.metaversomsp.com/assets/img/icons/closes.svg" alt="img"></a>';
      } else {
        htmlTags += '         <a class="me-3" id="Estado2" onclick="Estado2(' + item.id + ');" name="Estado2"';
        htmlTags += '         data-validar="SI" data-tipo="TABLA_MODAL" data-apodo="Eliminar Producto" style="cursor: pointer;" title="Votación Desactivada" ><img src="//pos.metaversomsp.com/assets/img/icons/expense1.svg" alt="img"></a>';
      }
      htmlTags += '     </td>';
