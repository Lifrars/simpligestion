...
function listarElecciones(ind, inicio, nroreg) {
  ...
  fetch('backend/votacionesBackend.php', { //Pa donde vamos
    ...
    data.rta2.forEach(function (item) {
      ...
      htmlTags += '     <td>' + (item.Total === "0" ? "Sin datos" : item.descripcion) + '</td>';
      htmlTags += '<td>';
      htmlTags += '<a href="grafico.php?dato=' + item.id + '" class="me-3" id="detail" onclick="detailvotacion(' + item.id + ');" name="detail" data-validar="SI" ';
      htmlTags += 'data-tipo="TABLA_MODAL" data-apodo="Detalles Votacion" style="cursor: pointer;" title="Detalles Votación"><img src="//pos.metaversomsp.com/assets/img/icons/eye.svg" alt="img"></a>';
      if (item.estado === "1") {
        htmlTags += '<a class="me-3" id="Votar" onclick="traervotacion(' + item.id + ');" name="Votar"';
        htmlTags += 'data-validar="SI" data-tipo="TABLA_MODAL" data-apodo="Votar" style="cursor: pointer;" title="Votar"><img src="//pos.metaversomsp.com/assets/img/icons/edit.svg" alt="img"></a>';
      } else {
        htmlTags += '<a class="me-3" id="Votar" onclick="Estado2(' + item.id + ');" name="Votar"';
        htmlTags += 'data-validar="SI" data-tipo="TABLA_MODAL" data-apodo="Votar" style="cursor: pointer;" title="Votar"><img src="//pos.metaversomsp.com/assets/img/icons/closes.svg" alt="img"></a>';
      }
      htmlTags += '</td>';
      htmlTags += ' </tr>';
    });
    ...
    if (inicio > 1) {
      ``
      paginador += '<li class="notDisable" style="margin-left: 0px;margin-right: 0px;"><a class="pagina" href="javascript:void(0)" onclick="listarElecciones(\'1\', 1, ' + nroreg + ', \'\', \'\', \'\', \'\', \'\', \'\')">&laquo;</a></li>';
      paginador += '<li class="notDisable" style="margin-left: 0px;margin-right: 0px;"><a class="pagina" href="javascript:void(0)" onclick="listarElecciones(\'1\', ' + (inicio - 1) + ', ' + nroreg + ', \'\', \'\', \'\', \'\', \'\', \'\')">&lsaquo;</a></li>';
