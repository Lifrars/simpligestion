                                    ...
                                    <div class="row">
                                        <div class="col-md-3 col-lg-3 col-sm-4 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="filtroPerfil" class="input-dark"
                                ...
                                <div class="panel-body" id="panel-bodyprincipal">
                                    <div class="responsive">
                                        <div class="table-wrapper">
                                            <table id="tablaPerfiles" class="table table-dark table-hover table-bordered" style="width:100%">
                                                <thead>
                                                    <tr>
                                                        <th style="text-align:center; font-weight:bold; font-size:14px;">ID</th>
                                                        <th style="text-align:center; font-weight:bold; font-size:14px;">PERFIL</th>
                                                        <th style="text-align:center; font-weight:bold; font-size:14px;">DESCRIPCIÓN</th>
                                                        <th style="text-align:center; font-weight:bold; font-size:14px;">ESTADO</th>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div>
                                            ...
                                            <div class="seccion-perfil">
                                                ...
                                                <div style="margin-bottom: 10px;">
                                                    <label for="inp_nombreperfil" style="font-weight: bold;">* Nombre Perfil:</label>
                                                    <input list="listaInpPerfil"
                                                        name="inp_nombreperfil"
                                                        id="inp_nombreperfil"
                                                        class="input-dark"
                                                        type="text"
                                                        maxlength="30"
                                                ...
                                                <!-- Botones -->
                                                <div style="margin-bottom: 15px; display: flex; gap: 1rem;">
                                                    <button type="button" id="btn-addPerfil"
                                                        name="btn-addPerfil"
                                                        class="btn btn-success btn-Guardar"
                                                        style="height:38px;" title="Presione para Guardar">
                                                        Crear Perfil
                                                    </button>
                                                    <div class="botonesadmin" style="display: flex; gap: 1rem;">
                                                        <button id="btnEditarPerfil" name="btnEditarPerfil" class="btn btn-warning">Editar Perfil</button>
                                                        <button style="opacity:1;width:100px;height:38px;font-size:16px;padding:5px;display:none;"
                                                            id="btnGuardarCambiosPerfil" name="btnGuardarCambiosPerfil"
                                                            class="btn btn-warning">Guardar</button>
                                                        <button type="button"
                                                            style="opacity:1;width:100px;height:38px;font-size:16px;padding:5px;display:none;"
                                                            id="cancelarEdicion" class="btn btn-danger" data-bs-dismiss="modal">Cancelar</button>
                                                ...
                                                <div style="margin-bottom: 15px;">
                                                    <label for="txt_observa" style="font-weight: bold;">* Descripción:</label>
                                                    <textarea name="txt_observa"
                                                        id="txt_observa"
                                                        maxlength="46"
                                                        rows="2"
                                                        class="input-dark"
                                                        placeholder="SERA EL QUE VOTE"></textarea>
                                                </div>
                                                ...
                                                <div id="row-estado">
                                                    <div class="checkbox">
                                                        <div class="form-group-sm">
                                                            <div class="estado" style="margin-bottom: 5px;">
                                                                <b id="lbl3" style="font-weight:bolder;">Estado</b>
                                                            </div>
                                        ...
                                        <div id="div_permisosAdd" name="div_permisosAdd" style="display: none;">
                                            <h4 style="color: white;">Restricciones <span id="spanCountRestricciones"></span></h4>

                                            <!-- FILTROS -->
                                            <div class="container mt-3">
                                                <div id="div_filtros" class="row d-flex justify-content-between">

                                                    <div id="div_filtro_modulo" class="col-xl-2 col-lg-3 col-md-12">
                                                        <h5 class="nombre" style="color:white;">Módulo</h5>
                                                        <select name="filtro_modulo" id="filtro_modulo" class="input-dark"></select>
                                                    </div>

                                                    <div id="div_filtro_vista" class="col-xl-2 col-lg-3 col-md-12">
                                                        <h5 class="nombre" style="color:white;">Vista</h5>
                                                        <select name="filtro_vista" id="filtro_vista" class="input-dark"></select>
                                                    </div>

                                                    <div id="div_filtro_nivel" class="col-xl-2 col-lg-3 col-md-12" style="display:none;">
                                                        <h5 class="nombre" style="color:white;">Elementos</h5>
                                                        <select name="filtro_nivel" id="filtro_nivel" class="input-dark"></select>
                                                    </div>

                                                    <div id="addboton" class="col-xl-6 col-lg-3 col-md-12 text-center d-flex align-items-center justify-content-center">
                                                        <button type="button" id="btn-AddPermiso" class="btn btn-success" style="height:38px;">Agregar Restricción</button>
                                                    </div>
                                                </div>
                                            </div>

                                            <!-- FORMULARIO DE PERMISOS -->
                                            <div id="div_permisosDatos" class="mt-4">
                                                <div class="row mb-3">
                                                    <div class="col">
                                                        <label style="color:white; font-weight:bold;">Nivel</label>
                                                        <select id="sel_mod" name="sel_mod" class="input-dark">
                                                            <option value="0"></option>
                                                        </select>
                                                        <select id="sel_vista" name="sel_vista" class="input-dark">
                                                            <option value="0"></option>
                                                        </select>
                                                        <select id="sel_elem" name="sel_elem" class="input-dark">
                                                            <option value="0"></option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col">
                                                        <label style="color:white; font-weight:bold;">Tipo Restricción</label>
                                                        <select id="sel_tipoRestriccion" name="sel_tipoRestriccion" class="input-dark">
                                                            <option value="0"></option>
                                                            <option value="1">Bloquear</option>
                                                            <option value="2">Ocultar</option>
                                                            <option value="3">Ofuscar</option>
                                                        </select>

                                                        <button type="button" id="btn-GuardarPermiso" class="btn btn-success">Agregar Restricción</button>
                                                        <button type="button" id="btn-CancelarAgregarPermiso" class="btn btn-danger">Cancelar</button>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <iframe id="frameshow" src="" frameborder="0" width="100%" height="400px"></iframe>
                                                    </div>
                                                </div>
                                            </div>

                                            <!-- TABLA VISUAL -->
                                            <div id="div_permisosTabla" class="mt-4">
                                                <table id="tableData2" class="table table-striped table-responsive dark-table">
                                                    <thead>
                                                        <tr>
                                                            <th>Nivel de Restricción</th>
                                                            <th>Módulo</th>
                                                            <th>Vista</th>
                                                            <th>Elemento</th>
                                                            <th>Permiso</th>
