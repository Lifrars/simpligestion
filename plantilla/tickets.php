    ...
    <div class="main-wrapper">
        <div class="container">
            <div class="card rounded mt-5">
                ...
                <div class="card-body ">
                               <h4 class="mb-0">Gestión de Quejas</h4>
                <div style="margin-bottom: 20px;"> <!-- Ajusta el valor de margin-bottom según necesites -->
                    <button type="button" class="btn btn-primary add-user-btn" id="addUsuario" data-toggle="modal" data-target="#largeModal">Agregar queja</button>
                </div>
                <div class="mb-3">
                             <input type="text" id="buscador" class="form-control w-25 ml-3 " placeholder="Buscar ticket..." style="height: 35px; font-size: 12px;">
                </div>
